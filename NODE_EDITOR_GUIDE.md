...
- **オブジェクト**: 球（Sphere）、平面（Plane）、ボックス（Box）
- **マテリアル**: Diffuse、Metal、Glass、Emission、MaterialBSDF
- **数学**: Vector3、Float、Color
- **カメラ**: カメラノード（DoF対応）
- **ライト**: ポイントライト、ディレクショナルライト、アンビエントライト
- **シーン**: シーン出力ノード
...
### 実装済み機能
- ✅ **プロパティの編集**: ノードの詳細パラメータの編集UI（PropertyPanelView）
- ✅ **接続のプレビュー**: ドラッグ中の接続線表示
- ✅ **マテリアルノード**: Diffuse/Metal/Glass/Emission対応

### 今後の拡張可能性
1. **コンテキストメニュー**: 右クリックでの操作メニュー
2. **複数選択**: Ctrl+クリックでの複数ノード選択
3. **コピー＆ペースト**: ノードの複製機能
4. **Undo/Redo**: 操作履歴の管理
5. **ミニマップ**: 大きなグラフのナビゲーション
6. **スナップ機能**: グリッドへのスナップ
