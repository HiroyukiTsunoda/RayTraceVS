...
- ✅ Canvasベースのノードエディタ
- ✅ ノードモデル（基底クラス）
- ✅ ノード接続システム（互換性チェック、再配線対応）
- ✅ ノードソケット（入出力、型チェック）
- ✅ MVVMアーキテクチャ（CommunityToolkit.Mvvm）
- ✅ Undo/Redo機能（Commandパターン）
- ✅ 複数選択（矩形選択）
- ✅ 一括移動・削除
- ✅ FBXメッシュインポート（Resource/Modelフォルダ）
...
- ベジェ曲線による接続線描画（互換性に応じた色表示）
- Commandパターンによる Undo/Redo
...
- [ ] 法線マップ
- [ ] パストレーシング（より正確なGI）
- [x] ~~デノイザー~~ ✅ NRD統合済み（REBLUR + SIGMA）
- [ ] リアルタイムプレビュー（低解像度）
- [x] ~~フォトンマッピング~~ ✅ コースティクス対応済み
...
**UI/UX:**
- [ ] ノードテンプレート
- [x] ~~ショートカットキー拡張~~ ✅ Ctrl+Z/Y、Delete等
- [x] ~~アンドゥ/リドゥ~~ ✅ Commandパターンで全操作対応
- [x] ~~複数選択~~ ✅ 矩形選択、一括操作対応
- [ ] ミニマップ
- [ ] ノード検索
- [ ] コピー＆ペースト
